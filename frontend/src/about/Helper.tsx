const Helper: React.FC = (props) => {
    ...
    const shortcutData = [
        {
            ...
            items: [
                ...
                { key: 'Temporary Quit Control Mode (Only in control mode)', shortcut: 'Q' },
            ]
        },
        {
    ...
    return (
        <div className="flex flex-wrap justify-betweenp-8 rounded-xl max-w-3xl mx-auto shadow-xl max-h-screen overflow-auto">
